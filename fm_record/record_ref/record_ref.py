...
class record_ref(gr.top_block, Qt.QWidget):

    def __init__(self, center_freq=89000000, channel_freq=89700000, file_loc="/tmp/lasso_capture", hackrf_index=0, num_samples=10000000, samp_rate=2000000):
        gr.top_block.__init__(self, "Record Ref")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Record Ref")
        ...
        self.settings = Qt.QSettings("GNU Radio", "record_ref")
        ...
        self.osmosdr_source_0 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'hackrf=0,bias=0'
        )
...
def argument_parser():
    ...
    parser.add_argument(
        "--center-freq", dest="center_freq", type=intx, default=89000000,
        help="Set center_freq [default=%(default)r]")
    parser.add_argument(
        "--channel-freq", dest="channel_freq", type=intx, default=89700000,
